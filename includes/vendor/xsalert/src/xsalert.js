...
function XSAlert({
   ...
   return new Promise(function(resolve, reject) {
      setTimeout(function(){
         ...
         /* Icons */
         if(icon == 'success'){ icon = 'icons/success.png'; };
         if(icon == 'warning'){ icon = 'icons/warning.png'; };
         if(icon == 'error'){ icon = 'icons/error.png'; };
         if(icon == 'question'){ icon = 'icons/question.png'; };
         if(icon == 'notification'){ icon = 'icons/notification.png'; };
         if(icon == 'like'){ icon = 'icons/like.png'; };
         if(icon == 'thumbup'){ icon = 'icons/thumbup.png'; };
         if(icon == 'thumbdown'){ icon = 'icons/thumbdown.png'; };
